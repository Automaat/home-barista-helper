...
export const grinders: Grinder[] = [
  ...
  // Commandante
  { id: 'commandante-c40-std', name: 'C40 MK4', brand: 'Commandante', type: 'manual', variants: ['Standard Axle'] },
  { id: 'commandante-c40-red', name: 'C40 MK4', brand: 'Commandante', type: 'manual', variants: ['Red Clix'] },
